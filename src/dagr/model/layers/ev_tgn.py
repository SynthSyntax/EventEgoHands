...
class EV_TGN(torch.nn.Module):
    ...
    def forward(self, events: Data, reset=True):
        ...
        # print("events.batch shape:", events.batch.shape, "dtype:", events.batch.dtype, "device:", events.batch.device)
        # print("pos shape:", pos.shape, "dtype:", pos.dtype, "device:", pos.device)

# Ensure both tensors are on the same device
        assert events.batch.device == pos.device, "Mismatch: events.batch and pos are on different devices!"
