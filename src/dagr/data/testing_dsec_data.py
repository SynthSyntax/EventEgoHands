...
class DSEC(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        tracks = tracks_to_array(detections_0)
        img = cv2.imread("/cfs/earth/scratch/kotabha1/image.png")
        img_out = cv2.imread("/cfs/earth/scratch/kotabha1/image.png")
        for track in tracks:
            x,y,w,h,c = track
            x2 = int(x + w)
            y2 = int(y + h)
        ...
        cv2.imwrite("/cfs/earth/scratch/kotabha1/image_out.png", img_out)
        print("the tracks before giving to the dataloader is:", tracks_to_array(detections_0))
        print("the datatype of the image being given to the dataloader is:", image_0.dtype)
...
obj = DSEC(root=Path("/cfs/earth/scratch/kotabha1/dagr_branch_test/dagr/data/dsec"), split="train", debug=False,
