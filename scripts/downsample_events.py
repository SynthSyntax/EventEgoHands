...
if __name__ == '__main__':
    ...
    filehandle = h5py.File(args.input_path, 'r')

    change_map = None
    pbar = tqdm.tqdm(total=num_iterations+1)
    for i in range(num_iterations):
        events = extract_from_h5_by_index(filehandle, i * num_events_per_chunk, (i+1) * num_events_per_chunk)
    ...
    events = extract_from_h5_by_index(filehandle, num_iterations * num_events_per_chunk, num_events)
